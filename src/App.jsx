...
const RACE_EVENTS = [
  ...
  { id:23, date:"2026-09-26", name:"Hever Castle Swim Series", location:"Edenbridge, Kent", type:"Open water", distances:"1 mile, 2.5km, 5km", link:"https://findarace.com/events/the-castle-swim-series-hever-castle", deadline:null, org:"Castle Race Series" },
  { id:24, date:"2026-06-07", name:"IRONMAN 70.3 Bolton", location:"Pennington Flash CP, Leigh, Greater Manchester", type:"IRONMAN", distances:"1.9km swim + 90km bike + 21.1km run", link:"https://www.ahotu.com/event/ironman-70-3-bolton", deadline:null, org:"IRONMAN" },
  { id:25, date:"2026-06-14", name:"IRONMAN 70.3 Staffordshire", location:"Stafford, Staffordshire", type:"IRONMAN", distances:"1.9km swim + 90km bike + 21.1km run", link:"https://www.cannockchasecyclecentre.co.uk/ironman-70-3-staffordshire", deadline:null, org:"IRONMAN" },
  { id:26, date:"2026-09-20", name:"IRONMAN 70.3 Weymouth", location:"Weymouth, Dorset", type:"IRONMAN", distances:"1.9km swim + 90km bike + 21.1km run", link:"https://findarace.com/events/ironman-70-3-weymouth", deadline:null, org:"IRONMAN" },
  ...
  { id:45, date:"2026-06-06", name:"Dorney Lake Triathlon (June)", location:"Dorney Lake, Windsor, Berkshire", type:"Triathlon", distances:"Sprint and Standard distance", link:"https://www.runthrough.co.uk/event/dorney-lake-triathlon-june-2026", deadline:null, org:"RunThrough" },
  ...
  { id:57, date:"2026-09-13", name:"Vitruvian Triathlon", location:"Whitwell, Rutland Water, Rutland", type:"Triathlon", distances:"Middle distance - 1.9km swim + 89km bike + 21km run", link:"https://www.thevitruviantriathlon.com/", deadline:null, org:"Pacesetter Events" },
  { id:58, date:"2026-09-19", name:"Rutland Night Triathlon", location:"Whitwell, Rutland Water, Rutland", type:"Triathlon", distances:"Evening triathlon", link:"https://www.britishtriathlon.org/events/rutland-night-triathlon_17052", deadline:null, org:"British Triathlon listed event" },
  { id:59, date:"2026-09-20", name:"Dawlish Triathlon", location:"Dawlish Warren, Devon", type:"Triathlon", distances:"Super Sprint, plus aquabike options", link:"https://findarace.com/events/dawlish-triathlon", deadline:null, org:"Sportiva Events" },
  { id:60, date:"2026-09-20", name:"Eton Dorney Triathlon", location:"Dorney Lake, Windsor, Berkshire", type:"Triathlon", distances:"Sprint 750m / Super Sprint 400m swim", link:"https://www.votwo.co.uk/eton-dorney-triathlon-2026", deadline:null, org:"Votwo" },
  { id:61, date:"2026-09-26", name:"Hever Castle Triathlon & Multisport", location:"Edenbridge, Kent", type:"Triathlon", distances:"Multiple distances", link:"https://www.castleraceseries.com/events/hever-castle/", deadline:null, org:"Castle Race Series" },
  { id:62, date:"2026-09-26", name:"Mumbles Multi-Sport Festival", location:"Knab Rock, Mumbles, Swansea Bay", type:"Triathlon", distances:"Olympic and Sprint triathlon, plus duathlon/aquabike/swim-only entries", link:"https://findarace.com/events/mumbles-multi-sport-festival", deadline:null, org:"Activity Wales Events" },
  { id:63, date:"2026-08-23", name:"Bosphorus Cross-Continental Swim", location:"Istanbul, Turkey (Kanlica to Kurucesme)", type:"Open water", distances:"6.5km", link:"https://bogazici.olimpiyat.org.tr/", deadline:"2026-07-15", org:"Turkish National Olympic Committee" },
  { id:64, date:"2026-08-29", name:"Bodensee-Openwater: Wallhausen-Uberlingen Crossing", location:"Lake Constance, Wallhausen to Uberlingen, Germany", type:"Open water", distances:"2.5km, 5km", link:"https://www.bodensee-openwater.com/wp-content/uploads/2025/11/20260829-Q2_Q5-Wallhausen-Ueberlingen.pdf", deadline:"2026-08-14", org:"Bodensee-Openwater" },
  { id:65, date:"2026-08-29", name:"Traversee de Montereau a la nage", location:"Montereau-Fault-Yonne, France", type:"Open water", distances:"10km, 5km, 2.5km, 500m, 100m", link:"https://www.ffneaulibre.fr/evenements/voir/6397/traversee-de-montereau-a-la-nage-montereau-fault-yonne", deadline:null, org:"FFN Eau Libre / Ville de Montereau-Fault-Yonne" },
  { id:66, date:"2026-09-05", name:"OCEANMAN Gijon", location:"Gijon, Spain", type:"Open water", distances:"10km, 5km, 1.5km, plus Kids/Teams/Fins", link:"https://oceanmanswim.com/races/gijon-spain/", deadline:null, org:"OCEANMAN" },
  { id:67, date:"2026-09-05", name:"Capri-Napoli (Elite race)", location:"Capri to Naples, Italy", type:"Open water", distances:"36km", link:"https://web.caprinapoli.com/", deadline:null, org:"Eventualmente Eventi & Comunicazione / FIN" },
  { id:68, date:"2026-09-05", name:"X-WATERS Slovenia", location:"Lake Bled, Slovenia", type:"Open water", distances:"500m, 1 mile, 5km, 10km, 2x500m relay", link:"https://x-waters.com/events/slovenia/?lang=en", deadline:null, org:"X-WATERS" },
  { id:69, date:"2026-09-12", name:"Rovinj Swim Marathon \"Sv. Eufemija\"", location:"Rovinj, Croatia", type:"Open water", distances:"3000m, 1500m", link:"https://www.rovinjswim.com/", deadline:"2026-09-09", org:"PK Delfin Rovinj-Rovigno" },
  { id:70, date:"2026-09-13", name:"OCEANMAN Banyuls", location:"Banyuls-sur-Mer, France", type:"Open water", distances:"10km, 5km, 2.5km, plus Kids/Teams/Fins", link:"https://oceanmanswim.com/races/banyuls-%C2%B7-france/", deadline:null, org:"OCEANMAN" },
  ...
  { id:83, date:"2027-03-27", name:"X-WATERS Thailand", location:"Phuket Island, Thailand", type:"Open water", distances:"1K, 3K, 5K, 2x1K, 1K Finswimming, X-Kids - opens the X-WATERS World Championship 2027 season", link:"https://x-waters.com/events/thailand/?lang=en", deadline:null, org:"X-WATERS" },
  { id:84, date:"2027-04-03", name:"IRONMAN 70.3 Vilamoura-Algarve", location:"Vilamoura, Algarve, Portugal", type:"IRONMAN", distances:"1.2 mile swim, 56 mile bike, 13.1 mile run - inaugural edition, opens the European IRONMAN 70.3 season", link:"https://www.220triathlon.com/news/ironman-launch-new-2027-european-70-3-triathlon-race-in-portugal", deadline:null, org:"IRONMAN" },
  { id:85, date:"2027-05-08", name:"OCEANMAN Costa Azahar", location:"Costa Azahar, Spain", type:"Open water", distances:"OCEANMAN, Half Oceanman, Sprint, OceanKids, OceanTeams - 8-9 May", link:"https://oceanmanswim.com/races/costa-azahar-spain-2027", deadline:null, org:"OCEANMAN" },
  { id:86, date:"2027-05-08", name:"X-WATERS Antalya", location:"Konyaalti Beach Park, Antalya, Turkey", type:"Open water", distances:"500m, 1 mile, 4km, 8km - 8-9 May", link:"https://x-waters.com/events/antalya/?lang=en", deadline:null, org:"X-WATERS" },
  { id:87, date:"2027-05-15", name:"IRONMAN Lanzarote", location:"Lanzarote, Canary Islands, Spain", type:"IRONMAN", distances:"3.8km swim, 180km bike, 42.2km run - 35th edition, first under direct IRONMAN Group organisation", link:"https://triatlonchannel.com/2026/06/18/ironman-lanzarote-abre-inscripciones-2027/", deadline:null, org:"IRONMAN" },
  { id:88, date:"2027-05-22", name:"OCEANMAN Cattolica", location:"Cattolica, Emilia Romagna, Italy", type:"Open water", distances:"OCEANMAN, Half Oceanman, Sprint, OceanKids, OceanTeams - 22-23 May", link:"https://oceanmanswim.com/races/cattolica-emilia-romagna-italy", deadline:null, org:"OCEANMAN" },
  { id:89, date:"2027-05-22", name:"OTILLO Swimrun Rugen", location:"Rugen, Germany", type:"Swimrun", distances:"Multiple swimrun distances around the Baltic island of Rugen", link:"https://otilloswimrun.com/races/rugen-germany/", deadline:null, org:"OTILLO Swimrun" },
  { id:90, date:"2027-05-28", name:"UltraOceanman Tabarca", location:"Tabarca, Spain", type:"Open water", distances:"UltraOceanman long-distance format - 28-29 May", link:"https://oceanmanswim.com/races/ultraoceanmantabarca2027", deadline:null, org:"OCEANMAN" },
  { id:91, date:"2027-05-29", name:"Castle Race Series - Lough Cutra Castle", location:"Lough Cutra Castle, South Galway, Ireland", type:"Triathlon", alsoTypes:["Aquathlon"], distances:"Multiple distances incl. triathlon, duathlon, aquabike, aquathlon, swim and run - 29-30 May", link:"https://www.castleraceseries.com/events/", deadline:null, org:"Castle Race Series" },
  { id:92, date:"2027-06-05", name:"Supertri Blenheim Palace Triathlon", location:"Blenheim Palace, Woodstock, Oxfordshire", type:"Triathlon", distances:"Super Sprint, Sprint and Weekend Warrior formats - 5-6 June", link:"https://www.blenheimpalace.com/whats-on/events/triathlon/", deadline:null, org:"Supertri / Blenheim Palace" },
  { id:93, date:"2027-06-11", name:"Great North Swim", location:"Lake Windermere, Cumbria", type:"Open water", distances:"Swim250, half mile, 1 mile, 2 mile, 5K, 10K, plus SwimRun options - 11-13 June", link:"https://greatswim.org/great-north-swim/", deadline:null, org:"Great Swim (Great Run Company)" },
  { id:94, date:"2027-06-11", name:"British Masters Championships (50m) 2027", location:"Sunderland Aquatic Centre, Sunderland", type:"Masters swimming", distances:"Long course 50m pool championships, England hosting the 2027 edition - 11-13 June", link:"https://www.swimming.org/masters/british-masters-championships/", deadline:null, org:"Swim England (GB Masters Swimming)" },
  { id:95, date:"2027-06-11", name:"OCEANMAN Lago d'Orta", location:"Lago d'Orta, Italy", type:"Open water", distances:"UltraOceanman format - 11-13 June", link:"https://oceanmanswim.com/races/lagodorta2027", deadline:null, org:"OCEANMAN" },
  { id:96, date:"2027-06-12", name:"Castle Race Series - Chateau de Chantilly", location:"Chateau de Chantilly, France", type:"Triathlon", alsoTypes:["Aquathlon"], distances:"Multiple distances incl. triathlon, duathlon, aquabike, aquathlon, swim and run - 12-13 June", link:"https://www.castleraceseries.com/events/", deadline:null, org:"Castle Race Series" },
  { id:97, date:"2027-06-12", name:"OTILLO Swimrun Uto", location:"Uto, Stockholm archipelago, Sweden", type:"Swimrun", distances:"Experience 7.04km, Sprint 18.18km, World Series 32.1km - traditional start of the Swedish swimrun season", link:"https://otilloswimrun.com/races/uto-sweden/", deadline:null, org:"OTILLO Swimrun" },
  { id:98, date:"2027-06-13", name:"Slateman Triathlon & Duathlon", location:"Llanberis, Gwynedd, Wales", type:"Triathlon", distances:"Sprint, Standard, Legend (70.3), Ultra (140.6) and Standard Duathlon", link:"https://alwaysaimhighevents.com/events/slateman-triathlon", deadline:null, org:"Always Aim High Events" },
  { id:99, date:"2027-06-18", name:"OCEANMAN Vouliagmeni", location:"Vouliagmeni, Greece", type:"Open water", distances:"OCEANMAN, Half Oceanman, Sprint, OceanKids, OceanTeams, OceanFins - 18-20 June", link:"https://oceanmanswim.com/races/vouliagmeni-greece-2027", deadline:null, org:"OCEANMAN" },
  { id:100, date:"2027-06-19", name:"Chillswim Coniston 5.25 Miles End to End", location:"Coniston Water, Cumbria", type:"Open water", distances:"5.25 miles", link:"https://chillswim.com/chillswim-coniston-end-to-end/", deadline:null, org:"Chillswim" },
  { id:101, date:"2027-06-26", name:"OCEANMAN Kyiv", location:"Kyiv, Ukraine", type:"Open water", distances:"OCEANMAN, Half Oceanman, Sprint, OceanKids, OceanTeams, OceanFins - 26-27 June (check FCDO travel advice before booking)", link:"https://oceanmanswim.com/races/kyiv-ukraine-2027", deadline:null, org:"OCEANMAN" },
  { id:102, date:"2027-06-26", name:"Castle Race Series - Cholmondeley Castle", location:"Cholmondeley Castle, Cheshire", type:"Triathlon", alsoTypes:["Aquathlon"], distances:"Multiple distances incl. triathlon, duathlon, aquabike, aquathlon, swim and run - 26-27 June", link:"https://www.castleraceseries.com/events/", deadline:null, org:"Castle Race Series" },
  { id:103, date:"2027-06-27", name:"Mainova IRONMAN Frankfurt European Championship", location:"Frankfurt am Main, Germany", type:"IRONMAN", distances:"3.8km swim, 180km bike, 42.2km run (save-the-date per organiser, exact date pending final confirmation)", link:"https://www.facebook.com/ironmangermany/posts/-save-the-date-27-june-2027-mainova-ironman-frankfurt-european-championship-%EF%B8%8F%EF%B8%8F%EF%B8%8F-/1420030570158367/", deadline:null, org:"IRONMAN" },
  { id:104, date:"2027-06-29", name:"World Aquatics Masters Championships - Budapest 2027", location:"Budapest, Hungary", type:"Masters swimming", alsoTypes:["Open water"], distances:"Masters Open Water 29-30 June, Masters pool Swimming 3-9 July - held fully alongside the elite World Championships for the first time", link:"https://www.worldaquatics.com/competitions/5574/world-aquatics-masters-championships-budapest-2027", deadline:null, org:"World Aquatics" },
  { id:105, date:"2027-07-03", name:"World Aquatics Championships - Budapest 2027 (Open Water)", location:"Budapest, Hungary", type:"Open water", distances:"Elite World Championships open water programme, 3-8 July", link:"https://www.worldaquatics.com/competitions/5546/world-aquatics-championships-budapest-2027", deadline:null, org:"World Aquatics" },
  { id:106, date:"2027-07-03", name:"OTILLO Swimrun Engadin", location:"Engadin, Switzerland", type:"Swimrun", distances:"The race credited with starting the international swimrun movement", link:"https://otilloswimrun.com/races/engadin-switzerland/", deadline:null, org:"OTILLO Swimrun" },
  { id:107, date:"2027-07-10", name:"Chillswim Ullswater 7.5 Miles End to End", location:"Ullswater, Cumbria", type:"Open water", distances:"7.5 miles", link:"https://chillswim.com/chillswim-ullswater-end-to-end/", deadline:null, org:"Chillswim" },
  { id:108, date:"2027-07-17", name:"Castle Race Series - Belvoir Castle", location:"Belvoir Castle, Leicestershire/Lincolnshire", type:"Triathlon", alsoTypes:["Aquathlon","Swimrun"], distances:"Multiple distances incl. triathlon, duathlon, aquabike, aquathlon, swim and run - 17-18 July", link:"https://www.castleraceseries.com/events/", deadline:null, org:"Castle Race Series" },
  { id:109, date:"2027-07-23", name:"World Triathlon Multisport Championships Edmonton - Aquathlon", location:"Hawrelak Park, Edmonton, Canada", type:"Aquathlon", distances:"Part of the World Triathlon Multisport Championships (16-25 July) - Aquathlon World Championship on 23 July, elite/age-group/para", link:"https://events.triathlon.org/2027-world-triathlon-multisport-championships-edmonton", deadline:null, org:"World Triathlon" },
  { id:110, date:"2027-07-24", name:"OTILLO Swimrun Gothenburg", location:"Gothenburg, Sweden", type:"Swimrun", distances:"Archipelago swimrun course out of Gothenburg", link:"https://otilloswimrun.com/races/gothenburg-sweden/", deadline:null, org:"OTILLO Swimrun" },
  { id:111, date:"2027-08-28", name:"BLDSA Loch Lomond 2027", location:"Loch Lomond, Scotland", type:"Open water", distances:"21.6 miles end-to-end (overnight, staggered start from 4pm Sat) and 1km option - 28-29 Aug", link:"https://bldsa.org.uk/swim/championship-events/loch-lomond/", deadline:"2027-07-25", org:"BLDSA" },
  { id:112, date:"2027-08-28", name:"IRONMAN 70.3 World Championship", location:"Chattanooga, Tennessee, USA", type:"IRONMAN", distances:"1.2 mile swim, 56 mile bike, 13.1 mile run - pro race 28 Aug, age-group race 29 Aug", link:"https://slowtwitch.com/triathlon/its-back-to-chattanooga-2027-ironman-70-3-world-championship-host-announced/", deadline:null, org:"IRONMAN" },
];
